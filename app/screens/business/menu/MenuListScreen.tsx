    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: async () => {
            try {
              await BusinessService.deleteBar(barId);
              Alert.alert('Success', 'Bar deleted successfully', [
                {
                  text: 'OK',
                  onPress: () => navigation.navigate('BarListScreen'),
                },
              ]);
            } catch (error) {
              console.error('Error deleting bar:', error);
              Alert.alert('Error', 'Failed to delete bar');
            }
          },
        },
      ]
